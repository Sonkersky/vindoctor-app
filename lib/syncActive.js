...
export function mapApiActiveLotToRow(apiLot) {
  return {
    ...
    // Celowo BEZ raw_json (w przeciwieństwie do "cars") — active_lots ma
    // realny lot_id jako klucz od razu (nic z niego nie trzeba później
    // odzyskiwać z JSON-a, jak przy cars.lot_id), a przy setkach tysięcy
    // wierszy sam ten jeden jsonb-owy bezpiecznik odpowiadał za większość
    // zajmowanego miejsca w bazie.
    raw_json: null,
